...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.1, 0.2)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.0, 0.3)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 1), glm::vec3(0.1, 0.7, 0.4)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.3, 0.7, 0.64)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0, 0), glm::vec3(0.3, 0.3, 0.3)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 1, 1), glm::vec3(0.1, 0.5, 0.4))
        };
   ...
   // meshes["tetr_A"] = new Mesh("generated tetraedrum 1");
   // meshes["tetr_A"]->InitFromData(vertices1, indices1);
    CreateMesh("tetr_A", vertices1, indices1);
    ...
    CreateMesh("sqr", vertices2, indices2);
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetr_A"], shaders["VertexColor"], glm::vec3(1.5f, 1.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["sqr"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.25f));
